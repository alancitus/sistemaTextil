...
$(document).ready(function(){
	...
	var colsModel = [ 
		...
		{name:'Nombre', index:'Nombre', sopt: 'like', formatter: function(cellvalue, options, rowObject){
				return jqGridCreateLink('mantenimiento/Costo/' + rowObject.id, cellvalue);
			}},
	...
	var grid = jqGridStart('list', 'pager', 'mantenimiento/ajax/CargarCostos', colsNames, colsModel, '', '' );
...
<div class="row">
	<div class="col-md-12">
		<div class="page-header">
			<a class="btn btn-default pull-right" href="<?php echo base_url('index.php/mantenimiento/costo'); ?>">
		...
		<ol class="breadcrumb">
		  ...
		  <li class="active">Costos de Producción</li>
		</ol>
		<div class="row">
			<div class="col-md-12">
