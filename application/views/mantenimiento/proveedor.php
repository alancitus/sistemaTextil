		...
		<div class="row">
			<div class="col-md-12">
				...
				<?php endif; ?>
				  ...
				  <div class="form-group">
				    <label>RUC</label>
				    <input autocomplete="off" maxlength="11" name="Ruc" type="text" class="form-control" placeholder="Ingrese el RUC" value="<?php echo $proveedor != null ? $proveedor->Ruc : null; ?>" />
				  </div>
				  <div class="form-group">
				    <label>DNI</label>
				  ...
				  <div class="form-group">
				    ...
				    <textarea name="Direccion" class="form-control" placeholder="Dirección"><?php echo $proveedor != null ? $proveedor->Direccion : null; ?></textarea>
				  </div>
				  <div class="clearfix text-right">
				  <?php if(isset($proveedor)): ?>
				  	<button type="button" class="btn btn-danger submit-ajax-button del" value="<?php echo base_url('index.php/mantenimiento/proveedoreliminar/' . $proveedor->id); ?>">Eliminar</button>
			  	  <?php endif; ?>
